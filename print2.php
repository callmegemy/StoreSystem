...
<body>
    ...
    $id_print = $_GET['print'];
    $select_print =  $connect->query("SELECT * FROM trader_invoice WHERE id ='$id_print'");
                ...
                <form>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span id="search" class="text-right"><?php echo $print['trader_name']?></span>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span id="result" class="text-right"><?php echo $print['total_trade']?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span id="num3" class="text-right"><?php echo $print['paid_trade']?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span id="result2" class="text-right"><?php echo $print['residual_trade']?></span>
                        </div>
                    </div>
